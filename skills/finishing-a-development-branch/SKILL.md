...
Once the merged result is green: archive docs (Step 7), clean up the worktree (Step 6), then
delete the branch:
...
**Then: Archive docs (Step 7)** and create the pull/merge request against <base-branch> with the forge's
...
Then: Archive docs (Step 7), clean up the worktree (Step 6) and force-delete the branch:
```bash
git branch -D <feature-branch>
```
